...
def parse_args():
    parser = argparse.ArgumentParser(description="Add follow-up to Cursor Cloud Agent")
    ...
    parser.add_argument(
        "--prompt", type=str, required=True, help="Follow-up instruction text"
    )
    ...
    parser.add_argument("--image", type=str, help="Path to image file to include")
