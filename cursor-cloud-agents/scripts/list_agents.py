...
def parse_args():
    parser = argparse.ArgumentParser(description="List Cursor Cloud Agents")
    ...
    parser.add_argument("--pr-url", type=str, help="Filter by PR URL")
    ...
    parser.add_argument(
        "--all-pages", action="store_true", help="Fetch all pages (auto-paginate)"
    )
